// https://github.com/kodie/moment-holiday/blob/master/moment-holiday.js
...
moment.fn.holiday = function(holidays, adjust) {
  ...
  if (!holidays) {
    ...
    for (var i = 0; i < holidays.length; i++) {
      if (td = findHoliday(this, String(holidays[i]), adjust)) { d = Object.assign({}, d, td); }
    }
  }
